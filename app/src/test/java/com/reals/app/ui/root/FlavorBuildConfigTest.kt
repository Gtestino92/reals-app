...
class FlavorBuildConfigTest {
    ...
    fun `app check providers and dependencies are variant scoped`() {
        ...
        val prodDebugInstaller = appFile("src/prodDebug/java/com/reals/app/core/appcheck/AppCheckInstaller.kt").readText()
        val prodReleaseInstaller = appFile("src/prodRelease/java/com/reals/app/core/appcheck/AppCheckInstaller.kt").readText()
        ...
        assertTrue(gradleFile.contains("""add("prodDebugImplementation", libs.firebase.appcheck.debug)"""))
        assertTrue(gradleFile.contains("""add("prodReleaseImplementation", libs.firebase.appcheck.playintegrity)"""))
        ...
        assertTrue(prodDebugInstaller.contains("DebugAppCheckProviderFactory"))
        assertTrue(prodReleaseInstaller.contains("PlayIntegrityAppCheckProviderFactory"))
        ...
        assertTrue(!prodDebugInstaller.contains("PlayIntegrityAppCheckProviderFactory"))
        assertTrue(!prodReleaseInstaller.contains("DebugAppCheckProviderFactory"))
        ...
        assertTrue(!File("app/src/prod/java/com/reals/app/core/appcheck/AppCheckInstaller.kt").exists())
        assertTrue(!File("src/prod/java/com/reals/app/core/appcheck/AppCheckInstaller.kt").exists())
    }
